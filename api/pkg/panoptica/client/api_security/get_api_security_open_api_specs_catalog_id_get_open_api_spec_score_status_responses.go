...
func (o *GetAPISecurityOpenAPISpecsCatalogIDGetOpenAPISpecScoreStatusReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetAPISecurityOpenAPISpecsCatalogIDGetOpenAPISpecScoreStatusOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewGetAPISecurityOpenAPISpecsCatalogIDGetOpenAPISpecScoreStatusUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewGetAPISecurityOpenAPISpecsCatalogIDGetOpenAPISpecScoreStatusOK() *GetAPISecurityOpenAPISpecsCatalogIDGetOpenAPISpecScoreStatusOK {
	return &GetAPISecurityOpenAPISpecsCatalogIDGetOpenAPISpecScoreStatusOK{}
}
...
func (o *GetAPISecurityOpenAPISpecsCatalogIDGetOpenAPISpecScoreStatusOK) Error() string {
	return fmt.Sprintf("[GET /apiSecurity/openApiSpecs/{catalogId}/getOpenApiSpecScoreStatus][%d] getApiSecurityOpenApiSpecsCatalogIdGetOpenApiSpecScoreStatusOK  %+v", 200, o.Payload)
}
func (o *GetAPISecurityOpenAPISpecsCatalogIDGetOpenAPISpecScoreStatusOK) GetPayload() models.OpenAPISpecScoreStatus {
	return o.Payload
}

func (o *GetAPISecurityOpenAPISpecsCatalogIDGetOpenAPISpecScoreStatusOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetAPISecurityOpenAPISpecsCatalogIDGetOpenAPISpecScoreStatusUnauthorized() *GetAPISecurityOpenAPISpecsCatalogIDGetOpenAPISpecScoreStatusUnauthorized {
	return &GetAPISecurityOpenAPISpecsCatalogIDGetOpenAPISpecScoreStatusUnauthorized{}
}
...
func (o *GetAPISecurityOpenAPISpecsCatalogIDGetOpenAPISpecScoreStatusUnauthorized) Error() string {
	return fmt.Sprintf("[GET /apiSecurity/openApiSpecs/{catalogId}/getOpenApiSpecScoreStatus][%d] getApiSecurityOpenApiSpecsCatalogIdGetOpenApiSpecScoreStatusUnauthorized ", 401)
}

func (o *GetAPISecurityOpenAPISpecsCatalogIDGetOpenAPISpecScoreStatusUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
