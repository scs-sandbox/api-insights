...
func (m *APIServiceListExternal) validateItems(formats strfmt.Registry) error {
...
func (m *APIServiceListExternal) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *APIServiceListExternal) UnmarshalBinary(b []byte) error {
	var res APIServiceListExternal
