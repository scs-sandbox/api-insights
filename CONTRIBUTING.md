...
## Report bugs using Github's [issues](https://github.cisco.com/cisco-developer/api-insights/issues)
We use GitHub issues to track public bugs. Report a bug by [opening a new issue](https://github.cisco.com/cisco-developer/api-insights/issues).
...
* Please run gloangci lint with rules defined in `.golangci.lint`
